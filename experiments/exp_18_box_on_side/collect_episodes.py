...
from key_dynam.utils.utils import save_yaml, load_yaml, get_data_root, get_project_root
...
def sample_pusher_position_and_velocity(T_aug=None, N=1000):
...
def main():
    ...
    OUTPUT_DIR = os.path.join(get_data_root(), "dev/experiments/18/data", DATASET_NAME)
    print("OUTPUT_DIR:", OUTPUT_DIR)
